...
export SIGNAL_FAMILIES="${SIGNAL_FAMILIES:-baseline gateway_injected controller_scheduler controller_preload controller_targeted_prefetch controller_demote_restore controller_admission}"
