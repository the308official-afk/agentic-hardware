...
AGENTIC_KV_TORCH_PROFILER_START_AGENT_PHASE="${AGENTIC_KV_TORCH_PROFILER_START_AGENT_PHASE:-}"
...
echo "Latest synthetic master report Markdown: ${LATEST_REPORT_ROOT}/latest_synthetic_master_report.md"
echo "Latest synthetic master report JSON: ${LATEST_REPORT_ROOT}/latest_synthetic_master_report.json"
echo "Latest synthetic checkpoint CSV: ${LATEST_REPORT_ROOT}/latest_synthetic_master_checkpoint_results.csv"
echo "Latest synthetic key observations CSV: ${LATEST_REPORT_ROOT}/latest_synthetic_master_key_observations.csv"
