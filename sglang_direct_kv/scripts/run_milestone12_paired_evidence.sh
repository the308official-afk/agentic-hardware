...
echo "Latest synthetic master report Markdown: ${LATEST_REPORT_ROOT}/latest_synthetic/master_report.md"
echo "Latest synthetic master report JSON: ${LATEST_REPORT_ROOT}/latest_synthetic/master_report.json"
echo "Latest synthetic checkpoint CSV: ${LATEST_REPORT_ROOT}/latest_synthetic/checkpoint_results.csv"
echo "Latest synthetic key observations CSV: ${LATEST_REPORT_ROOT}/latest_synthetic/key_observations.csv"
