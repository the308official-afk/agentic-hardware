...
export SIGNAL_FAMILIES="${SIGNAL_FAMILIES:-baseline gateway_injected controller_scheduler controller_demote_restore controller_admission controller_full controller_full_chunked}"
