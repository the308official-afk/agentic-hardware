...
export AGENTBENCH_EXECUTION_LOOP_MAX_STEPS="${AGENTBENCH_EXECUTION_LOOP_MAX_STEPS:-3}"
...
echo "Latest report: ${LATEST_REPORT_ROOT}/latest_live_agentbench_prefetch_report.html"
