...
filter_measured_modes() {
  ...
  for mode in $1; do
    case "${mode}" in
      no_prefetch|direct_prefetch|dynamo_priority_hints|oracle_prefetch)
      ...
      *)
        ...
        echo "Measured modes: no_prefetch direct_prefetch dynamo_priority_hints oracle_prefetch" >&2
