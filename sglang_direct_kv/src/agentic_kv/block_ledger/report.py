        ...
        rows.append(
            {
                ...
                "exact_correlation_source": record.exact_correlation_source,
            ...
            output.append(
                {
                    ...
                    "agent_request_id": block.get("agent_request_id", ""),
                    "correlation_id": block.get("correlation_id", ""),
                    "case_id": block.get("case_id", ""),
                    "gap_id": block.get("gap_id", ""),
                    ...
                    "exact_correlation_source": block.get("exact_correlation_source", ""),
        ...
        rows.append(
            {
                ...
                "movement_kind": event.movement_kind,
...
def exact_movement_summary_rows(rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    correlated = sum(1 for row in rows if row.get("correlation_id") or row.get("request_id"))
    return [
        ...
        {"metric": "rows with request/correlation identity", "value": correlated},
